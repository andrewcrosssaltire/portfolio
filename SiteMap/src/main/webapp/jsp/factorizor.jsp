...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div>
                <form method=post action="factresponse" class="form-horizontal">
                    <div class="form-group">
                        <center>
                            <div class="col-md-3"></div>
                            <label for="factor" class="col-md-3">What number to factor?</label>
                            <div class="col-md-3">
                                <input type="text" name="factor" class="form-control" placeholder="Feed me a number!"><br>
                            </div>
                            <div class="col-md-3"></div>
                            <div class="col-md-12"></div>
                            <div class="col-md-12">
                                <button type="submit" class="btn-btn-default">Factorize Me!</button>
                            </div>
                        </center>
                    </div>
                </form>
